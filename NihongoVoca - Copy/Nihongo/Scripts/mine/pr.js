    ...
    $('#btnOkChoosingModal').on('click', function () {
        ...
        if (selectedValue != '') {
            ...
            if (selectedValue != resultValue) {
                ...
                $('#divResultMessageChoosing').html('<strong>SAI!</strong>');
                return false;
            }
            else {
            ...
            if (index == vocas.length - 1) {
                ...
                if (vocas[index].DisplayType == '3') {
                    //Kanji
                    $('#vMeaningChoosing').html(vocas[index].VMeaning);
                }
    ...
    $('#btnOkTranslatingModal').on('click', function () {
        ...
        if (selectedValue != '') {
            ...
            if (selectedValue != resultValue) {
                ...
                $('#divResultMessageTranslating').html('<strong>SAI!</strong>');
                return false;
            }
            else {
